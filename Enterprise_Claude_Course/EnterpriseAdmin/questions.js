test.AddQuestion( new Question ("ec_q1",
                                ...
                                new Array("Workspace", "Organization", "User Profile", "Artifacts"),
                                "Organization",
                                "obj_admin_basics")
                );
...
test.AddQuestion( new Question ("ec_q4",
                                ...
                                QUESTION_TYPE_CHOICE,
                                new Array("OAuth 1.0", "SAML 2.0", "LDAP", "FTP"),
                                "SAML 2.0",
                                "obj_security")
                );
...
test.AddQuestion( new Question ("ec_q5",
                                ...
                                QUESTION_TYPE_CHOICE,
                                new Array("Yes, to improve performance for all users", "Only if the user clicks 'thumbs up'", "No, enterprise data is never used for training by default", "Yes, but only for the first 30 days"),
...
test.AddQuestion( new Question ("ec_q6",
                                ...
                                QUESTION_TYPE_CHOICE,
                                new Array("Org Admin", "Workspace Admin", "Billing Admin", "Viewer"),
                                "Workspace Admin",
                                "obj_roles")
                );
...
test.AddQuestion( new Question ("ec_q7",
                                ...
                                QUESTION_TYPE_CHOICE,
                                new Array("A list of every word Claude generated", "User login times and changes to organization-wide settings", "The browser history of every employee", "Private Slack messages"),
...
test.AddQuestion( new Question ("ec_q8",
                                ...
                                QUESTION_TYPE_CHOICE,
                                new Array("PCI-DSS", "SOC 2 Type II", "ISO 9001", "FERPA"),
                                "SOC 2 Type II",
                                "obj_compliance")
                );
